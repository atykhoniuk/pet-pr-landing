...
//Используем классы для карточек
    ...
    Object(_services_services__WEBPACK_IMPORTED_MODULE_1__["getResource"])('http://localhost:3000/menu')
        .then(data => {
...
function forms(modalTimerId) {
    ...
    function bindPostData(form) {
        form.addEventListener('submit', (e) => {
            ...
            const json = JSON.stringify(Object.fromEntries(formData.entries())) // entries создает массив массивов
...
window.addEventListener('DOMContentLoaded', () => {
    const modalTimerId = setTimeout(() => Object(_modules_modal__WEBPACK_IMPORTED_MODULE_4__["openModal"])('.modal', modalTimerId), 600000);
    ...
    Object(_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2021-10-22');
